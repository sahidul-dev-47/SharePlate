...
export const metadata: Metadata = {
  title: "SharePlate — Share extra food, not waste",
  description:
    "SharePlate connects restaurants, home cooks, and shops with surplus food to neighbors nearby, before it goes to waste.",
};
